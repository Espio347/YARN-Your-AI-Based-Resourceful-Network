        ...
        <section className="relative">
            <div>
                <FrameCard
                    ...
                    likes={frame.likes || []} // Ensure likes is an array
                    likeCount={frame.likeCount}
                    image={frame.image} // Add the image property
                />
            </div>
            ...
            <div className="mt-10">
                {frame.children.map((childItem: any) => (
                    <FrameCard
                        ...
                        isComment
                        likes={childItem.likes || []} // Ensure likes is an array
                        likeCount={childItem.likeCount}
                        image={childItem.image} // Add the image property
                    />
                ))}
            </div>
        </section>
